...
const CreateModal = ({painting, onClose}: CreateModalProps) => {
    return (
        <>
            ...
            <div id="update-modal" aria-hidden="true" className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-50 w-[500px] p-4 overflow-x-hidden overflow-y-auto max-h-[90dvh]">
